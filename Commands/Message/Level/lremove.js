    ...
    if(status == "active")
    {
      if(channel)
      {
        ...
        let emb = new MessageEmbed()
            ...
            .addFields(
              {
                name: "<a:ARROW:955461848734531604> Requested By :",
                value: `ㅤㅤ╰-𒆕 ${message.member.user}`
              },
              {
                name: "<a:ARROW:955461848734531604> Level log system Successfully deleted",
        ...
        let emb = new MessageEmbed()
            ...
            .addFields(
              ...
              {
                name: "<a:ARROW:955461848734531604> Level log system cannot be deleted",
