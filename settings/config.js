...
module.exports = {
  TOKEN: "MTE0NTcyMzk2ODA0OTkwOTg5MQ.GqmL_E.-ItiXoefkTZ1M3Coi1TbysctbdW1EDx5QTGyU0",
 
  PREFIX: process.env.PREFIX || ">",

  
  embed: {
    color: process.env.color || "A020F0",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "Foxnight Coders | ",
    footericon: "🔥",
  },
  ...
  // others
  mongodb : process.env.mongodb || "mongodb+srv://arjunn:premiumop123@cluster0.dpw1dmi.mongodb.net/?retryWrites=true&w=majority",
  ...
  links: {
    DiscordServer: `https://discord.com/invite/ece2R4zXVQ`
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true
